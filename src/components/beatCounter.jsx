            ...
            <CardContent className="space-y-4">
                ...
                <div className="text-center">
                    ...
                    <Badge variant="outline"
                           className={`mt-2 ${isPlaying ? 'bg-green-50 border-green-200 text-green-700' : 'bg-gray-50 border-gray-200 text-gray-600'}`}>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {selectedTaal.bols.map((bol, index) => (
                            <Badge key={index} variant="outline"
                                   className="bg-white/70 border-indigo-200 text-indigo-700">
                                {bol}
                            </Badge>
                        ))}
                    </div>
